...
def gen_all_modules(
    ...
    if add_comm:
        ...
        # SM12x supports the fused TRT-LLM allreduce but not MNNVL (#3170).
        if has_sm100 or has_sm120 or has_sm121:
    ...
    if add_misc:
        ...
        # Runtime selects the _sm100 SSU module for sm_major >= 10 (incl. SM110
        # and SM12x); register it so FLASHINFER_DISABLE_JIT works there (#3170).
